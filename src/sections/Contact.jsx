  ...
  return (
    <div className={`${darkMode ? `dark bg-black` : `light bg-transparent`}`}>
      ...
      >
        <div
          data-aos="zoom-in"
          className="bg-white dark:bg-black p-10 flex flex-col justify-center
        ...
        >
          ...
          ></textarea>
          <button
            className="bg-red-600 w-full text-md px-8 py-3 
          text-white font-semibold rounded-xl hover:bg-black dark:hover:bg-red-700 cursor-pointer"
          >
            SEND EMAIL
          </button>
        </div>
        <div className="flex flex-col justify-center items-start gap-8 lg:p-20 p-6">
          ...
          <p data-aos="zoom-in" data-aos-delay="400" className='text-xl
          text-gray-600 text-justify dark:text-white'>
